...
const citySlice = city.slice(cityIndex);
console.log('substring:',citySubstring,'     oppure slice:',citySlice); // Output: "York"

// 3. Sostituzione
// Sostituisci 'York' con 'Delhi'
const cityReplaced = city.replace(citySlice,'Delhi');
